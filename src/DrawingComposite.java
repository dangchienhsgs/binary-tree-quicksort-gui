...
public class DrawingComposite extends ScrolledComposite {
    ...
    public void setNodeMouseListener(final TreeNode treeNode) {
        ...
        // add submenu
        /*Menu popupMenu=new Menu (treeNode.node);
        final TreeNode temp=treeNode;
        MenuItem findSuccessor=new MenuItem(popupMenu, SWT.CASCADE);
        findSuccessor.setText("Find successor");
        ...
        treeNode.node.setMenu(popupMenu);
        ///*/
    ...
    public void remove_changeValue(){
        ...
        TreeNode temp=rightMinNode.parent;
        ...
        System.out.println ("RightminNode: "+rightMinNode.getValue());

        tree.computeAllNodeTree();
        resetBounds(tree.root);
        resetLine(treeNode);
        System.out.println ("Check: "+temp.left.getValue());
        composite.redraw();
    }
    ...
    public void resetBounds(TreeNode treeNode) {
        if (treeNode != null) {
            System.out.println ("Reset Bounds: "+treeNode.getValue()+" "+treeNode.position+" "+treeNode.level);
            if (treeNode.parent!=null) System.out.println ("Parent: "+treeNode.parent.getValue());
    ...
    public void findSucesscor(int value){
        ...
        if (treeNode!=null){
            System.out.println ("Tim succesor"+treeNode.getValue());
            if (treeNode.right==null){
